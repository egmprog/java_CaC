 ...
 * Temas:
 * ArrayList
 * Clases (se usa una clase creada en archivo aparte llamada: Operacion)
 */
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 5; i++) {
            ...
            switch (operador) {
                ...
                case 1:
                    miOperacion.sumar(num1, num2);
                    break;
                case 2:
                    miOperacion.restar(num1, num2);
                    break;
                case 3:
                    miOperacion.multiplicar(num1, num2);
                    break;
                case 4:
                    miOperacion.dividir(num1, num2);
                    break;
